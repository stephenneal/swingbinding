...
public class StateBinding {
    /**
     * Create a binding of a bean property to the editable property of a {@link JTextComponent}.
     * <p>
     * The {@link UpdateStrategy} is {@link UpdateStrategy#READ}, when binding is being used for state the state should only be updated via the property it is bound to.
     * </p>
     * 
     * @param bean
     *            bean to bind
    ...
    /**
     * Create a binding of a bean property to the editable property of a {@link JComboBox}.
     * <p>
     * The {@link UpdateStrategy} is {@link UpdateStrategy#READ}, when binding is being used for state the state should only be updated via the property it is bound to.
     * </p>
     * 
    ...
    /**
     * Create a binding of a bean property to the foreground property of a {@link JComponent}.
     * <p>
     * The {@link UpdateStrategy} is {@link UpdateStrategy#READ}, when binding is being used for state the state should only be updated via the property it is bound to.
     * </p>
     * 
     ...
     * @return binding instance
     */
    public static <B> Binding<B, Color, JComponent, Color> foreground(B bean, Property<B, Color> bP, JComponent component) {
     ...
     * @return binding instance
     */
    private static <B> Binding<B, Boolean, JComponent, Boolean> booleanState(B bean, Property<B, Boolean> bP,
     ...
     * @return binding instance
     */
    private static <B, V> Binding<B, V, JComponent, V> state(B bean, Property<B, V> bP,
            JComponent component, String componentPropertyName) {

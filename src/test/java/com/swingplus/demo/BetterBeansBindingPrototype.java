...
public class BetterBeansBindingPrototype extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        final BetterBeansBindingPrototype prototype = createPrototype(binding);
    ...
    private static BetterBeansBindingPrototype createPrototype(BindingService bindingService) {
        ...
        return new BetterBeansBindingPrototype(model, bindingService);
    }
    ...
    public BetterBeansBindingPrototype(BindingPrototypeModel model, BindingService bindingService) {
        super();
